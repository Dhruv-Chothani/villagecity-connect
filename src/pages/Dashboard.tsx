...
import { GraduationCap, ShoppingCart, Briefcase, Heart, Monitor, Tractor, Wrench, BookOpen, Users, LayoutDashboard } from "lucide-react";
    ...
    <div className="container py-8">
      ...
      {isAdmin && (
        <div className="mb-8 rounded-xl border-2 border-secondary/30 bg-secondary/5 p-6">
          <h2 className="mb-2 font-bold text-secondary">⚡ Admin Panel</h2>
