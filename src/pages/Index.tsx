...
import myImage from "../assets/smartvillage.png"; 
...
const Index = () => {
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="relative overflow-hidden gradient-hero px-4 py-16 text-primary-foreground md:py-24">
        <div className="container relative z-10 text-center">
          <div className="mx-auto mb-6 flex h-32 w-32 items-center justify-center rounded-2xl bg-white shadow-lg">
            <img src={logo} alt="SVCDA Logo" className="h-28 w-28" />
          </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {sectors.map((s, i) => (
            <Link
              key={s.key}
              to={s.path}
              className="sector-card group overflow-hidden rounded-2xl border bg-card shadow-sm transition-all hover:shadow-lg hover:-translate-y-1"
            >
              <div className="relative h-40 overflow-hidden">
                ...
                <div className={`absolute top-4 left-4 flex h-12 w-12 items-center justify-center rounded-xl ${s.color} text-primary-foreground shadow-lg transition-transform duration-300 group-hover:scale-110`}>
